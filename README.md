...
Uma conta gratuita no New Relic para obter a License Key.
...
Projeto criado para fins de estudo e demonstração de arquiteturas modernas, microsserviços e observabilidade avançada.# projeto-final-java-banking
